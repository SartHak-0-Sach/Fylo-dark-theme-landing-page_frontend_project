...
The challenge is to create the Fylo Dark Theme Landing Page, the landing page of a website called Fylo designed for storing and easy accessing of files uploaded on Fylo. Users should be able to view the optimal layout for the site depending on their device's screen size and see hover states for all interactive elements on the page.
